'''
    All trades have a 0.2% commission.
...
class ExchangeEngine(ExchangeEngineBase):
    ...
    def get_ticker_lastPrice(self, ticker):
         return self._send_request('api/GetMarketOrders/{0}_BTC/10'.format(ticker), 'GET', {}, [self.hook_lastPrice(ticker=ticker)])
...
if __name__ == "__main__":
    ...
    engine.load_key('../.keys/cryptopia.key')
